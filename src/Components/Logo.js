...
class Logo extends React.Component {
  state = { eyeIsOpen: true, mouthIsOpen: true }

  componentDidMount() {
    setInterval(() => {
      this.blink('eyeIsOpen', 240)
    }, 4200)
  ...
  render() {
    ...
    return (
      <Planet
        ...
        height="200"
        viewBox="0 0 499 499"
        pose={isSearching ? 'isSearching' : 'notSearching'}
      >
        <Defs>
        ...
        <G id="logo-uber-cities" transform="translate(-391 -151)">
          <G transform="translate(391 151)">
            <Mask id="Mask-2" fill="#fff">
              <Use href="#Path-1" xlinkHref="#Path-1" />
            </Mask>
            <Use id="globe" fill="#59C6FF" href="#Path-1" xlinkHref="#Path-1" />
            <Path
              id="right-country"
              fill="#A6F8F4"
            ...
            <G id="face" Mask="url(#Mask-2)">
              <G transform="translate(168 220)">
                <Mouth
                  pose={mouthIsOpen ? 'openMouth' : 'closeMouth'}
                  id="mouth-group"
                  transform="translate(45 46)"
                >
                  <Mask id="Mask-4" fill="#fff">
                    <Use href="#Path-3" xlinkHref="#Path-3" />
                  </Mask>
                  <Use
                    id="mouth"
                    fill="#181743"
